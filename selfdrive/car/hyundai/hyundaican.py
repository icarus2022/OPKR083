...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
  ...
  if car_fingerprint in [CAR.GRANDEUR_HEV, CAR.GRANDEUR, CAR.SONATA, CAR.PALISADE, CAR.SONATA_HEV, CAR.SANTA_FE, CAR.KONA_EV, CAR.NIRO_EV, CAR.KONA_HEV, CAR.SELTOS]: 
