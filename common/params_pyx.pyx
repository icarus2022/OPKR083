...
keys = {
  ...
  b"OpkrUserOpen": [TxType.PERSISTENT],
  ...
  b"UserOption1": [TxType.PERSISTENT],
  b"UserOption2": [TxType.PERSISTENT],
  b"UserOption3": [TxType.PERSISTENT],
  b"UserOption4": [TxType.PERSISTENT],
  b"UserOption5": [TxType.PERSISTENT],
  b"UserOption6": [TxType.PERSISTENT],
  b"UserOption7": [TxType.PERSISTENT],
  b"UserOption8": [TxType.PERSISTENT],
  b"UserOption9": [TxType.PERSISTENT],
  b"UserOption10": [TxType.PERSISTENT],
  b"UserOptionName1": [TxType.PERSISTENT],
  b"UserOptionName2": [TxType.PERSISTENT],
  b"UserOptionName3": [TxType.PERSISTENT],
  b"UserOptionName4": [TxType.PERSISTENT],
  b"UserOptionName5": [TxType.PERSISTENT],
  b"UserOptionName6": [TxType.PERSISTENT],
  b"UserOptionName7": [TxType.PERSISTENT],
  b"UserOptionName8": [TxType.PERSISTENT],
  b"UserOptionName9": [TxType.PERSISTENT],
  b"UserOptionName10": [TxType.PERSISTENT],
  b"UserOptionNameDescription1": [TxType.PERSISTENT],
  b"UserOptionNameDescription2": [TxType.PERSISTENT],
  b"UserOptionNameDescription3": [TxType.PERSISTENT],
  b"UserOptionNameDescription4": [TxType.PERSISTENT],
  b"UserOptionNameDescription5": [TxType.PERSISTENT],
  b"UserOptionNameDescription6": [TxType.PERSISTENT],
  b"UserOptionNameDescription7": [TxType.PERSISTENT],
